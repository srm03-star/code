  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background smooth-transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "hero-gradient text-white border-0 hover:scale-105 glow-effect font-semibold shadow-lg",
        emergency: "emergency-gradient text-white border-0 hover:scale-105 animate-emergency-pulse font-semibold",
        safe: "bg-safe-zone text-white hover:bg-safe-zone/90 hover:scale-105",
        map: "bg-card border border-border hover:bg-muted hover:scale-105 shadow-md",
      },
      size: {
